...
const Registration = () => {
  ...
  return (
    <div className=" container flex mx-auto pt-24">
      <div className=" w-1/2">
        <img src="https://i.ibb.co/W3xCvLW/5423351-Mobile-login.jpg" alt="" />
      </div>
      <div className="card w-1/2  max-w-lg  my-8 shadow-2xl bg-base-100">

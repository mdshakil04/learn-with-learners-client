...
const Navbar = () => {
  const navLinks = (
    <>
      ...
      <li>
        <NavLink to="/addFood">All Classes</NavLink>
      </li>
      <li>
        <NavLink to="/availableFoods">Teach On</NavLink>
      </li>
      <li>
  ...
  return (
    <div className="navbar fixed z-10 bg-opacity-50 bg-[#176b87] text-white  font-bold  ">
